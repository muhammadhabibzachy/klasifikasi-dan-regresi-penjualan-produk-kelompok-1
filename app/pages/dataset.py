...
def merge_all(dfs: dict) -> pd.DataFrame:
    key_map = {
        ("stores.csv",          "train_potong.csv"):           ["store_nbr"],
        ("train_potong.csv",           "transactions.csv"):    ["date", "store_nbr"],
        ("train_potong.csv",           "oil.csv"):             ["date"],
        ("train_potong.csv",           "holidays_events.csv"): ["date"],
    }
    ORDER = ["train_potong.csv", "stores.csv", "transactions.csv", "oil.csv", "holidays_events.csv"]
...
def _show_erd():
    ...
    schemas = {
        "train_potong.csv":           {"kolom": ["date","store_nbr","family","sales","onpromotion"],             "pk": [],            "fk": ["store_nbr","date","family"], "color": "#38bdf8"},
    ...
    relations = [
        ...
        ("oil.csv",             "train_potong.csv",           "date"),
        ("oil.csv",             "transactions.csv",    "date"),
        ("oil.csv",             "holidays_events.csv", "date"),
        ("holidays_events.csv", "train_potong.csv",           "date"),
        ("transactions.csv",    "train_potong.csv",           "date, store_nbr"),
    ]
